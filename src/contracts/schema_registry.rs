...
pub mod schema_registry {
    ...
    pub static SCHEMAREGISTRY_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static SCHEMAREGISTRY_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static SCHEMAREGISTRY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl ::ethers::core::abi::AbiDecode for SchemaRegistryCalls {
        fn decode(
            ...
            if let Ok(decoded) = <GetSchemaCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for SchemaRegistryCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::GetSchema(element) => ::ethers::core::abi::AbiEncode::encode(element),
